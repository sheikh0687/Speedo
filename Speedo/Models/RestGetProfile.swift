...
struct ApiRestGetProfile : Codable {
    
    let message : String?
    let result : ResRestGetProfile?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent(ResRestGetProfile.self, forKey: .result)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }
    
}

struct ResRestGetProfile : Codable {
    ...
    let restDayDetails : [RestDayDetail]?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case restDayDetails = "rest_day_details"
        ...
        case wallet = "wallet"
        case restOpenStatus = "rest_open_status"
    }
    ...
    init(from decoder: Decoder) throws {
        ...
        restDayDetails = try values.decodeIfPresent([RestDayDetail].self, forKey: .restDayDetails)
        ...
        totalRatingCount = try values.decodeIfPresent(String.self, forKey: .totalRatingCount)
        ...
        restOpenStatus = try values.decodeIfPresent(String.self, forKey: .restOpenStatus)
    }
    
}

struct RestDayDetail : Codable {
