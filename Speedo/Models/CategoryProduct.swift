...
struct ApiProductsByCat : Codable {
    
    let message : String?
    let result : [ResProductsByCat]?
    let status : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        result = try values.decodeIfPresent([ResProductsByCat].self, forKey: .result)
        status = try values.decodeIfPresent(String.self, forKey: .status)
    }    
}

struct ResProductsByCat : Codable {
    ...
    let productAdditional : [RetProductAdditional]?
    let productImages : [RetProductImage]?
    let productLike : String?
    let productSize : [RetProductSize]?
    let restDetails : RetRestDetail?
    let restId : String?
    ...
    init(from decoder: Decoder) throws {
        ...
        productAdditional = try values.decodeIfPresent([RetProductAdditional].self, forKey: .productAdditional)
        ...
        productSize = try values.decodeIfPresent([RetProductSize].self, forKey: .productSize)
        restDetails = try values.decodeIfPresent(RetRestDetail.self, forKey: .restDetails)
...
struct RetProductAdditional : Codable {
